...
index_1.removeByIndexes([0], arr);
if (arr[0] === 'llo')
    console.log('test 1 passed');
else
    console.log('test 1 failed');
// Test 2: Make sure -1 removes last item:
index_1.removeByIndexes([-1], arr);
...
arr = ['he', 'llo', 'zz'];
index_1.removeByIndexes([0, 2], arr);
...
index_1.removeByIndexes([-2, 1], arr);
...
arr = ['he', 'llo', 'zz', 'gg', 'cc', 'aa'];
index_1.removeByIndexes([-6, 5], arr);
...
arr = ['he', 'llo', 'zz', 'gg', 'cc', 'aa'];
index_1.removeByIndexes([-6, -1], arr);
if (arrays_match_1.arraysMatch(arr, ['llo', 'zz', 'gg', 'cc']))
